 ...
 const Navbar = ({onNavClick})=>{
    ...
    return <>
        <nav className='navbar'>
            <ul>
                <li className='hideOnMobile'><a href="#" onClick={(e)=>{e.preventDefault(); onNavClick("home");}}>Sri<span>vandhi</span></a></li>
      ...
      <path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" />
        ...
        <nav className='sidebar' ref = {ref}>
            <ul>
                ...
                <li><a href="#" onClick={(e)=>{e.preventDefault(); onNavClick("aboutme");}}>AboutMe</a></li>
