            ...
            <div className="projects">
                ...
                <div className="project">
                    <div className="project-head">
                        <img src={`${process.env.PUBLIC_URL}/assets/react.png`} alt="React Logo" />
                        {/* ADDED: href, target, and rel attributes */}
                        <a href="https://github.com/Srivandhi/Personal-Portfolio-Website" target="_blank" rel="noopener noreferrer">
                            <h3>Portfolio</h3>
                        </a>
                    </div>
                    <p>
                        A Personal Portfolio Website built using React.js to showcase my skills, projects, and contact information.
                ...
                <div className="project">
                    <div className="project-head">
                        <img src={`${process.env.PUBLIC_URL}/assets/react.png`} alt="React Logo" />
                        {/* ADDED: href, target, and rel attributes */}
                        <a href="https://github.com/Srivandhi/relief-net-app" target="_blank" rel="noopener noreferrer">
                            <h3>ReliefNet - Full-Stack Disaster Relief Platform</h3>
                        </a>
                    </div>
                    <p>
                ...
                <div className="project">
                    <div className="project-head">
                        <img src={`${process.env.PUBLIC_URL}/assets/java.png`} alt="Java Logo" />
                        {/* ADDED: href, target, and rel attributes */}
                        <a href="https://github.com/Srivandhi/Smart-Attendance-System" target="_blank" rel="noopener noreferrer">
